...
/**
 * @param {{ project: Project, scope: Scope, turn: Turn|null, documentHtml: string, threads: Thread[], carryBack: import('./carry-back.js').CarryBackEntry[], sidebar: Sidebar, ingestionAvailable: boolean }} input
 * @returns {string}
 */
