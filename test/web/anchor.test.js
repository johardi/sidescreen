...
import { renderMarkdown } from '../../src/web/render-markdown.js';
import { AnchorError, describeRange, resolveAnchor } from '../../src/web/public/anchor.js';
import { clearMarks, wrapRange } from '../../src/web/public/marks.js';
...
test('every boundary pair over the document round-trips through a re-render', () => {
  ...
  /** @type {{ anchor: import('../../src/web/public/anchor.js').Anchor, text: string }[]} */
  const cases = [];
